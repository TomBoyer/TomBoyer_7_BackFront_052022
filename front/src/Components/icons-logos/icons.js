const LogOutIcon = () => {
  return (
    <svg className="logout-icon" width="1em" height="1em" viewBox="0 0 24 24">
      <path
...
const DeleteIcon = () => {
  return (
    <svg className="del-svg" width="1.5rem" height="1.5rem" viewBox="0 0 28 28">
      <path
...
export {
  /*MessageIcon, LikeIcon, DislikeIcon, HomeIcon,  EditIcon,  UpArrow, ModerationPanel */ ShowInput,
  DeleteIcon,
  HideInput,
  LogOutIcon,
  EditIcon,
